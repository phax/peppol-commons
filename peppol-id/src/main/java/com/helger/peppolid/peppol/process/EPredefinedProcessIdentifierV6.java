    ...
    implements IProcessIdentifier, IPeppolIdentifier
{
    ...
    private EPredefinedProcessIdentifierV6(@Nonnull @Nonempty final String sScheme, @Nonnull @Nonempty final String sID, @Nonnull @Nonempty final ICommonsList<String> aDocTypeIDs) {
        m_sScheme = sScheme;
        m_sID = sID;
