...
public final class ProcessIdentifierTypeMicroTypeConverter extends
                                                           AbstractIdentifierMicroTypeConverter <ProcessIdentifierType>
{
  @Override
  @Nonnull
  protected ProcessIdentifierType getAsNative (@Nullable final String sScheme, @Nonnull final String sValue)
  {
