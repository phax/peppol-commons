...
public enum EPredefinedIdentifierIssuingAgency implements IIdentifierIssuingAgency
{
   ...
   */
  SE_VAT ("SE:VAT", "Swedish VAT number", "9955", false, Version.parse ("1.2.1")),
   ...
   */
  DE_EPROC ("DE:EPROC", "German EProc number", "9956", false, Version.parse ("1.2.2")),
   ...
   */
  ZZZ ("ZZZ",
       "Unknown issuer agency\n(Not applicable for registration in PEPPOL SML).",
       "9999",
       false,
       Version.parse ("1.2.1"));
  ...
  @Nonnull
  public PeppolParticipantIdentifier createParticipantIdentifier (@Nonnull @Nonempty final String sIdentifier)
  {
