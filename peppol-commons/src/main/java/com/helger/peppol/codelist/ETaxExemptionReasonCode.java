...
public enum ETaxExemptionReasonCode implements IHasID <String>,IHasDisplayName
{
  ...
  SPECIAL_EXEMPTIONS_LINKED_TO_INTERNATIONAL_GOODS_TRAFFIC_ ("AAB Exempt",
  ...
  REVERSE_CHARGE_INTRA_COMMUNITY_TRANSPORT_SERVICES_ ("AAE Reverse Charge",
                                                      "Reverse Charge Intra-Community transport services."),
  EXEMPTION_UNDER_THE_SPECIAL_SCHEME_FOR_INVESTMENT_GOLD_ ("AAF Exempt",
  ...
  REVERSE_CHARGE_PROCEDURE_APPLYING_TO_SUPPLIES_OF_GOLD_ ("AAJ Reverse Charge",
