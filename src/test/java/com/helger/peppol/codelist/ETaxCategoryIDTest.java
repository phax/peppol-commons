...
public final class ETaxCategoryIDTest
{
  ...
  public void testBasic ()
  {
    for (final ETaxCategoryID e : ETaxCategoryID.values ())
    {
      ...
      assertNotNull (ETaxCategoryID.getDisplayNameFromIDOrNull (e.getID ()));
      assertSame (e, ETaxCategoryID.valueOf (e.name ()));
    }
    assertNull (ETaxCategoryID.getFromIDOrNull ("Yoda"));
    assertNull (ETaxCategoryID.getDisplayNameFromIDOrNull ("Yoda"));
  }
}
