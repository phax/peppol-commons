 ...
 * @since 13.0.0
 */
public enum EHREDeliveryTransportProfile implements ISMPTransportProfile
{
  /** HR eDelivery AS4 profile v1 */
  AS4_V1 ("eracun-transport-as4-v1_0", "HR eDelivery AS4 1.0", ESMPTransportProfileState.ACTIVE);

  private final String m_sID;
  private final String m_sName;
  private final ESMPTransportProfileState m_eState;

  EHREDeliveryTransportProfile (@NonNull @Nonempty final String sID,
  ...
  @Nullable
  public static EHREDeliveryTransportProfile getFromIDOrNull (@Nullable final String sID)
  {
    return EnumHelper.getFromIDOrNull (EHREDeliveryTransportProfile.class, sID);
  }
}
