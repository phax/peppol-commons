...
/**
 * Provide all HR eDelivery transport profiles to the central transport profile registry.
 *
 * @author Philip Helger
 * @since 13.0.0
 */
@IsSPIImplementation
public final class HREDeliveryTransportProfileProviderSPI implements ISMPTransportProfileProviderSPI
{
  @NonNull
  @ReturnsMutableCopy
  public ICommonsList <ISMPTransportProfile> getAllTransportProfiles ()
  {
    return new CommonsArrayList <> (EHREDeliveryTransportProfile.values ());
  }
}
