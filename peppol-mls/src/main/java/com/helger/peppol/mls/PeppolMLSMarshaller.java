...
/**
 * Special Peppol MLS Marshaller that does the same as the UBL 2.1 marshaller
 *
 * @author Philip Helger
 */
public class PeppolMLSMarshaller extends UBL21JAXBMarshaller <ApplicationResponseType>
{
  public PeppolMLSMarshaller ()
  {
