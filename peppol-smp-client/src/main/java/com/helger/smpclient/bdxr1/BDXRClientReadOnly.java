                                ...
                                IBDXRExtendedServiceMetadataProvider
{
  ...
  public ServiceGroupType getServiceGroup (@NonNull final IParticipantIdentifier aServiceGroupID) throws SMPClientException
  {
    ...
    final BDXR1MarshallerServiceGroupType aMarshaller = new BDXR1MarshallerServiceGroupType ();
                                                       ...
                                                       @Nullable final ISMPFollowRedirectCallback aFollowRedirectCallback) throws SMPClientException
  {
    ...
    SignedServiceMetadataType aMetadata;
    {
      ...
      final SMPHttpResponseHandlerSigned <SignedServiceMetadataType> aResponseHandler = configureResponseHandler (new SMPHttpResponseHandlerSigned <> (aMarshaller,
                                                                                                                                                       aTrustStore));
