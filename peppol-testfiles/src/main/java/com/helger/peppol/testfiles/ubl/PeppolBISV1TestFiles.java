...
public final class PeppolBISV1TestFiles
{
  ...
  private static final String [] CALLFORTENDERS_SUCCESS = { "Catalogue pre award_Call for Tender_RDO MEPA_BIS 12a.xml" };
  private static final String [] CATALOGUES_SUCCESS = { "Consip_Catalogo_UBL.xml" };
  private static final String [] CREDITNOTES_SUCCESS = { "BII05-TRDM014-example-at.xml",
                                                         "BII05-TRDM014-example-is.xml",
                                                         "creditnote-with-all-elements-new-creditorid.xml",
                                                         "creditnote-with-all-elements.xml" };
  private static final String [] CREDITNOTES_AT_SUCCESS = { "atgov_BIS5aCreditNote.xml",
                                                            "atgov-t14-BIS5A-valid.xml",
                                                            "atgov-t14-BIS5A-with-all-elements.xml" };
  private static final String [] INVOICES_SUCCESS = { "BII04 minimal invoice example 03.xml",
                                                      ...
                                                      "TC10.15.TS1.xml",
                                                      "test-invoice.xml" };
  private static final String [] INVOICES_AT_SUCCESS = { "atgov_BIS4aInvoice.xml",
                                                         "atgov_BIS5aInvoice.xml",
                                                         "atgov-t10-BIS4A-valid.xml",
                                                         "atgov-t10-BIS5A-valid.xml",
                                                         "atgov-ubl-42-8.xml" };
  private static final String [] ORDERS_SUCCESS = { "ADVORD_03_03_00_Order_v2p2.xml",
  ...
  private static final String [] ORDERRESPONSES_SUCCESS = { "CENBII-AcceptOrder-maximal.xml",
                                                            "CENBII-RejectOrder-maximal.xml" };
  private static final String [] TENDER_SUCCESS = { "Catalogo preaward_Tender_Risposta con offerta ad una RDO MEPA_BIS 12a.xml" };
  private static final String [] TENDERINGCATALOGUES_SUCCESS = { "Tender-Sample.xml" };

  private static final TestDocument [] CREDITNOTES_AT_ERROR = { new TestDocument ("atgov-t14-fail-r001.xml",
  ...
  private static final TestDocument [] INVOICES_ERROR = { new TestDocument ("ERR-2 BII04 minimal invoice example 02.xml",
  ...
  private static final TestDocument [] INVOICES_AT_ERROR = { new TestDocument ("atnat-t10-fail-r001.xml",
  ...
  /**
   * TC01.4.TS1.xml, TC01.5.TS1.xml, TC01.10.TS1.xml, TC01.39.TS1.xml, TC01.40.TS1.xml,
   * TC01.44.TS1.xml not XSD compliant
   */
  private static final TestDocument [] ORDERS_ERROR = { new TestDocument ("TC01.1.TS1.xml",
