...
public final class PeppolBISV1TestFiles
{
  ...
  private static final TestDocument [] CREDITNOTES_AT_ERROR = new TestDocument [] { new TestDocument ("atgov-t14-fail-r001.xml",
  ...
  private static final TestDocument [] INVOICES_ERROR = new TestDocument [] { new TestDocument ("ERR-2 BII04 minimal invoice example 02.xml",
   ...
   */
  private static final TestDocument [] ORDERS_ERROR = new TestDocument [] { new TestDocument ("TC01.1.TS1.xml",
